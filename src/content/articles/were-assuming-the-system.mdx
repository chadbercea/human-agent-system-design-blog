...
<aside class="anchor-framework-cta" aria-label="HAS-D framework navigation">
  <p class="anchor-framework-cta-lede">HAS-D v1.0 lives in three categories — <strong>Axioms</strong>, <strong>Constraints</strong>, and <strong>Design Requirements</strong>. Pick a hub to dig in, or read on for why the framework exists.</p>
  <FrameworkLocator />
</aside>
